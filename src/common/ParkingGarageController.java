...
public class ParkingGarageController
{
	...
	//Refer to the view (used in all the button methods, to call
	//  methods in the model) 
	public void addView(ParkingGarageView v) {
		view = v;
	}
	...
	public void updateView(int availability) throws RemoteException {
		view.update();
	}
